...
namespace IDC_WEB
{
    ...
    {
        public static List<string> lstMarketDetail = new List<string>() { "A", "CBOT", "CCFX", "COMEX", "HK", "LME", "N", "O", "SS", "SZ", "XDCE", "XSGE", "XZCE" };
        public static string marketDetail = "SS,SZ,HK,A,N,O,CBOT,CCFX,COMEX,LME,XDCE,XSGE,XZCE";
