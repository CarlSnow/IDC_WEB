...
namespace IDC_WEB
{
    public static class HttpService
    {
        ...
        public delegate WizardDetail InitializeWizardDetailHandler(string searchKey);
        public static event InitializeWizardDetailHandler InitializeWizardDetailEventHandler = InitializeBaseWizardInfo;
        ...
        private static string InitializeJson(string url)
        {
            ...
            string responseStr = converter.GetString(bytes);
            return responseStr;
        }
        ...
        private static WizardDetail InitializeBaseWizardInfoTask(string searchKey)
        {
            ...
            WizardDetail wizardDetail = (WizardDetail)JsonConvert.DeserializeObject(wizardDataDetailJson, typeof(WizardDetail));
            return wizardDetail;
        }
                ...
                for (int i = 0; i < jTokenArray.Length; i++)
                {
                    switch (i)
                    {
                        case 0:
                            ...
                            {
                                today = new DateTime(today.Year, today.Month, today.Day, hhmmss / 10000000, (hhmmss % 10000000) / 100000, (hhmmss % 100000) / 1000);
                            }
